...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<?php echo base_url('template') ?>/vendors/mdi/css/materialdesignicons.min.css"/>
            ...
            <div
              ...
              <!-- <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item dropdown d-lg-flex d-none">
                  ...
                  >
                    <p
                      class="mb-0 font-weight-medium float-left dropdown-header"
                    >
                      Reports
                    </p>
              ...
              <li class="nav-item">
                ...
                <div class="submenu">
                  <ul>
                    ...
                    <li class="nav-item">
                      <a class="nav-link"
                        href="<?php echo base_url('admin/isi_user') ?>"
                        >Tambah User</a>
                    </li>
                  </ul>
                </div>
